...
public class TestDataSeeder
{
    ...
    {
        var created = await DefaultEmailTemplateLibrary.EnsureAsync(_context, organisationId);
        _logger.LogInformation("Seeded {Count} email templates for org {OrgId}", created, organisationId);
    }
