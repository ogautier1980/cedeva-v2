...
| [test-strategy.md](test-strategy.md) | 5 niveaux de tests (~1192 unit/intégration + 65 E2E + 3 SQL, ≈92 % couverture), infra, 3 workflows CI, gate de couverture, pièges appris |
