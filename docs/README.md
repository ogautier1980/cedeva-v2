...
| [test-strategy.md](test-strategy.md) | 5 niveaux de tests (~1134 unit/intégration + 59 E2E + 3 SQL, ≈89 % couverture), infra, 3 workflows CI, gate de couverture, pièges appris |
